...
namespace Editor.Code
{
    public class SocWizard : EditorWindow
    {
        ...
        private static void RunProfileTest()
        {
        ...
        private void GenerateOcclusionPortal()
        {
            ...
            if (_spawnOnAsset)
            {
                ...
                newOcclusionPortal = Instantiate(occlusionPortalTemplate, _target.transform.position, Quaternion.identity) as GameObject;
        ...
        private void GenerateOcclusionArea()
        {
            ...
            if (_spawnOnAsset)
            {
                ...
                newOcclusionArea = Instantiate(occlusionAreaTemplate, position1, Quaternion.identity) as GameObject;
        ...
        private static void BakeStaticOcclusion()
        {
        ...
        private static void BackgroundBakeStaticOcclusion()
        {
            var currentScene = SceneManager.GetActiveScene();
            var currentSceneName = currentScene.name;
